      ...
      <div className="flex items-start justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-sm text-ink-300 mt-1">
            Every Monday morning we send you this email: money waiting, moves to make,
            and exactly how many steps until each dollar lands.
          </p>
        </div>
      ...
      {!hasLeads ? (
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-lg font-bold text-white">
                Your Monday recap unlocks with your first lead
              </h2>
              <p className="mt-1 text-sm text-ink-200">
                Once leads start landing in your inbox, this preview fills in with
                real pipeline value, hot leads to reply to, stalled ones to rekindle,
                and three concrete moves for the week — all built from your actual data.
              </p>
        ...
        <div className="glass-strong rounded-2xl overflow-hidden border border-cyan-500/20">
          ...
          <div className="p-5 sm:p-8 bg-ink-950/40 space-y-6">
            <div>
              <p className="text-xs text-ink-400 uppercase tracking-wider">This week</p>
              <h2 className="text-xl sm:text-2xl font-bold text-white mt-1">
                {firstName}, here's what's sitting in your pipeline.
              </h2>
            </div>
            ...
            <div className="rounded-xl bg-cyan-500/5 border border-cyan-500/20 p-4">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-ink-100 leading-relaxed">
                  ...
                  <span className="text-white font-semibold">{hotLeads.length} hot lead{hotLeads.length === 1 ? "" : "s"}</span> need a reply in the next 24 hours or they'll go cold.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <ol className="space-y-3 text-sm text-ink-100">
                <Move num={1}>
                  ...
                  Each one replied in under 5 minutes tends to convert several times higher than the ones that sit.
                </Move>
                <Move num={2}>
                  Send a short video or GIF to each stalled lead (
                  <Link href="/dashboard/scripts" className="text-cyan-400 underline">use Script L1 — the 45-second video bump</Link>
                  ). Replies go up when the bump offers value instead of just checking in.
                </Move>
                <Move num={3}>
                  Ask your most recent <span className="text-lead-400 font-semibold">Won</span> customers for a Google review (
                  <Link href="/dashboard/scripts" className="text-cyan-400 underline">Script T1</Link>
                  ). New reviews lift ad click-through.
                </Move>
              </ol>
            </div>
