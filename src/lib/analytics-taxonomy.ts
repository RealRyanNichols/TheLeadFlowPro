...
export const LEADFLOW_EVENT_TAXONOMY = [
  ...
  {
    name: "marketplace_filter_change",
    stream: "vercel_anonymous",
    eventType: "marketplace_filter_change",
  ...
  {
    name: "marketplace_page_view",
    stream: "vercel_anonymous",
    eventType: "marketplace_page_view",
  ...
  {
    name: "marketplace_card_click",
    stream: "vercel_anonymous",
    eventType: "marketplace_card_click",
  ...
  {
    name: "marketplace_modal_opened",
    stream: "vercel_anonymous",
    eventType: "marketplace_modal_opened",
  ...
  {
    name: "marketplace_sample_request_click",
    stream: "vercel_anonymous",
    eventType: "marketplace_sample_request_click",
  ...
  {
    name: "marketplace_sample_requested",
    stream: "vercel_anonymous",
    eventType: "marketplace_sample_requested",
  ...
  {
    name: "marketplace_access_request_click",
    stream: "vercel_anonymous",
    eventType: "marketplace_access_request_click",
    description: "Buyer clicks request access on a marketplace signal card.",
    allowedProperties: ["page", "signal_id", "signal_title", "category", "request_type", "lead_score"],
  },
  {
    name: "marketplace_access_requested",
    stream: "vercel_anonymous",
    eventType: "marketplace_access_requested",
    description: "Buyer submits a marketplace access request without personal identifiers.",
    allowedProperties: ["page", "listing_id", "category", "vertical", "lead_score", "request_type", "persisted"],
  },
  {
    name: "marketplace_watchlist_added",
    stream: "vercel_anonymous",
    eventType: "marketplace_watchlist_added",
  ...
  {
    name: "source_submission_reviewed",
    stream: "vercel_anonymous",
    eventType: "source_submission_reviewed",
  ...
  {
    name: "tools_start_click",
    stream: "vercel_anonymous",
    eventType: "tools_start_click",
  ...
  {
    name: "tools_signal_submit",
    stream: "vercel_anonymous",
    eventType: "tools_signal_submit",
  ...
  {
    name: "tools_signal_save_success",
    stream: "vercel_anonymous",
    eventType: "tools_signal_save_success",
  ...
  {
    name: "tools_signal_save_error",
    stream: "vercel_anonymous",
    eventType: "tools_signal_save_error",
  ...
  },
  {
    name: "buyer_login",
    stream: "vercel_anonymous",
    eventType: "buyer_login",
    description: "Buyer login completes without sending identity fields to Vercel.",
    allowedProperties: ["page", "method"],
  },
  {
    name: "buyer_profile_completed",
    stream: "vercel_anonymous",
    eventType: "buyer_profile_completed",
