...
export const OFFERS: Record<OfferSlug, Offer> = {
  ...
  "power-bundle": {
    ...
    category: "social",
    cadence: "monthly",
    badge: "Tier 2 · Monthly · Social content engine",
    Icon: Layers,
    metaTitle: "Power Bundle | Social Content Engine $1,497/mo | The LeadFlow Pro",
    metaDescription:
      "Ryan builds the social content engine, production workflow, posting rhythm, and reporting path across TikTok, Facebook, X, and YouTube.",

    hero: {
      h1Lead: "Four platforms. One content engine.",
      h1Highlight: "$1,497 a month for the social system.",
      paragraph:
        "The Power Bundle is not Ryan hand-editing every clip on his phone. It is the operating system: what to film, how raw footage becomes posts, where it gets published, and where attention goes next.",
      paragraph2:
        "Ryan builds the workflow, templates, posting rhythm, review loop, and lead route. The production lane is chosen on the fit call so the business gets a system instead of another vague social package.",
    },
    price: {
      big: "$1,497",
      sub: "/month · all 4 platforms",
      badge: "System first, content second",
      deliverables: [
        "Short-form engine: 20 planned outputs/mo from approved source footage, tool-assisted clips, or scoped production",
        "Facebook: weekly posts, short-video repurposing, proof posts, and group seeding plan",
        "X / Twitter: daily Mon–Fri posts in your voice + reply targeting",
        "YouTube: long-form direction, title/thumbnail review, retention notes, and Shorts repurposing path",
        "Production workflow: Opus, CapCut, templates, upload queue, or a custom coded intake tool when scoped",
        "Creative direction: what to film, what to say, what to show, and where the lead goes next",
        "Client-owned content hub for raw clips, approved posts, captions, links, and lead destinations",
        "Monthly performance report tied to calls, DMs, forms, clicks, and booked actions",
      ],
      addOn: {
        title: "Delivery model",
        body:
          "The default is Ryan designing and running the content engine, not Ryan personally editing every short. Source footage can come from you, your team, recorded calls, a field content day, Opus or CapCut workflows, or a scoped editor lane.",
      },
    },
    ...
    whyBuy: [
      ...
      { Icon: TrendingUp, title: "Repurposing pays the bill",  body: "One source clip can become a short, a Reel, an X post, a Facebook proof post, and a YouTube Short when the workflow is built correctly." },
      { Icon: ShieldCheck, title: "The account stays useful", body: "Attention needs a destination. The content engine points viewers into calls, forms, DMs, booking links, and follow-up instead of letting views disappear." },
    ],
    timeline: [
      { n: "1", minutes: "Week 1",   title: "Pick the delivery lane",  body: "We choose client-uploaded footage, recorded calls, Opus or CapCut workflow, custom upload queue, scoped editor, or field content day." },
      { n: "2", minutes: "Week 1–2", title: "Build the content OS",    body: "Shot list, folders, templates, captions, CTA routing, link path, posting calendar, and review loop get set up." },
      { n: "3", minutes: "Week 2",   title: "Ship the first cycle",    body: "The first clips and posts move through the chosen lane. Ryan reviews hooks, offer path, and where the lead goes next." },
      { n: "4", minutes: "Monthly",  title: "Report + iterate",        body: "We look at what got calls, DMs, form fills, clicks, replies, and booked actions. Then the next month gets sharper." },
    ],
    rightFit: [
      "Your buyers are on multiple platforms (most are)",
      "You can provide raw footage, call recordings, proof, photos, or someone who can capture it",
      "You want a content engine, not a request for Ryan to manually edit every asset",
      "You can show up for 1 weekly content sync (15-30 min)",
      "You're committed to 90 days minimum because consistency needs repetition",
      "You want lead flow, not vanity follower count",
    ],
    wrongFit: [
      "Your buyers are 100% on one platform (then buy that single channel)",
      "You have no footage, no proof, no offer, and no one willing to capture source material",
      "You expect Ryan to personally film and edit every short unless field production is scoped",
      "You want to approve every post before it moves",
    ...
    proof: RYAN_PROOF,
    faqs: [
      { q: "Who makes the shorts?", a: "Ryan does not personally hand-edit every short. Ryan builds the content engine, angles, shot list, workflow, review loop, posting path, and lead route. Shorts can come from client footage, your team, recorded calls, Opus, CapCut, a custom upload queue, or a scoped editor lane." },
      { q: "Do I have to make the shorts myself?", a: "You do not need to become a video editor. You do need a source of real footage or proof. That can be phone clips from your team, field clips, recorded calls, webinars, customer moments, screenshots, or a scoped content capture day." },
      { q: "Can Ryan build us a tool for this?", a: "Yes. If the bottleneck is workflow, we can scope a client-owned upload queue, clip request board, caption generator, approval tracker, or content dashboard. That is build work, not generic social posting." },
