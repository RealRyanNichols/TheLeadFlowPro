...
function PlanFooter() {
  ...
  return (
    <div className="p-4 border-t border-white/5 space-y-3">
      ...
      <SignOutButton variant="full" className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-xs font-semibold text-ink-200 hover:border-rose-400/40 hover:bg-rose-500/10 hover:text-rose-100" />
    </div>
  );
}
