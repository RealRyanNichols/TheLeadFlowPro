...
export function Topbar() {
  return (
    <header className="h-16 border-b border-white/5 bg-ink-950/70 backdrop-blur-xl flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link
          ...
          className="flex items-center gap-2 pl-2 pr-3 py-1.5 rounded-lg hover:bg-white/5"
        >
          ...
          <div className="hidden md:block text-left">
            ...
            <div className="text-[11px] text-ink-400 leading-none mt-0.5">{MOCK_USER.businessName}</div>
          </div>
        </Link>
      </div>
    </header>
