  ...
  return (
    <section className="py-24">
      <div className="container">
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-promo-glow p-10 md:p-16 text-center">
          <div className="absolute inset-0 -z-10 bg-grid-fade" />
          <h2 className="text-4xl md:text-5xl font-extrabold">
            See the data. <span className="funnel-text">Make the move.</span>
          </h2>
          <p className="mt-4 text-ink-200 text-lg max-w-2xl mx-auto">
