...
import LiveDashboard, {
  type LivePayload,
} from "@/components/live/LiveDashboard";
    ...
    <main className={`cb-page ${styles.page}`}>
        ...
        <div className="cb-shell cb-hero-layout">
          <div className="cb-hero-copy">
            ...
            <p className="cb-hero-lead">
              Anybody can claim they know how to build websites, capture
              attention, and create lead systems. This is the actual system
              working on the business you are looking at right now, with visitor
              privacy protected the whole way.
            </p>
            ...
            <p className="cb-hero-own">
              ...
              Privacy-safe public aggregates. Detailed customer data stays
              private.
            </p>
          </div>
      ...
      <section className={styles.dashboardSection}>
        ...
        <p className={styles.dataNote}>
          Every number on this page is a real aggregate from The LeadFlow
          Pro&apos;s own first-party analytics. Nothing is simulated, estimated,
          or seeded. Public metrics never include identities, exact locations,
          IP addresses, or anything a visitor typed. Detailed interaction
          tracking went live in August 2026 and grows from here.
        </p>
      </section>

      {/* ---- website grader ---- */}
      <section
        className={styles.graderSection}
        aria-labelledby="grader-heading"
      >
        <div className="lfp-ink p-5 sm:p-8">
          <div className="relative">
            ...
            <h2
              id="grader-heading"
              className="mt-2 font-display text-2xl font-black tracking-tight text-[#20212b] sm:text-3xl"
            >
              How does your website compare?
            </h2>
            <p className="mt-2 max-w-2xl text-[15px] leading-relaxed text-[#625f6d]">
              Plug in your address. We run the same checks Google runs, plus our
              own lead-capture radar, and put your grades next to this
              site&apos;s and the average of every site graded here. Three
              columns. Same ruler. No guessing.
            </p>
            <div className="mt-5">
              <WebsiteGrader />
            </div>
      ...
      {/* ---- what this can track ---- */}
      <section
        className={`cb-band ${styles.trackSection}`}
      ...
      >
        <div className="cb-shell">
          ...
          <p className="cb-lead">
            The post gets attention. The system makes money. This page is the
            reporting layer of the same machine we install for clients:
            websites, lead capture, CRM, follow-up, and analytics, connected in
            accounts you own.
          </p>
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {TRACK_GRID.map((item) => (
              <div key={item.title} className="card card-hover !p-5">
                ...
                />
                <h3 className="mt-3 font-bold text-[var(--heading)]">
                  {item.title}
                </h3>
      ...
      {/* ---- operator proof ---- */}
      <section
        className={`cb-band cb-band--ink ${styles.operatorSection}`}
        ...
        <div className="cb-shell">
          <div className="lfp-ink p-6 sm:p-10">
            <div className="relative">
              ...
              <h2
                id="operator-heading"
                className="mt-3 max-w-2xl font-display text-3xl font-black tracking-tight text-[#20212b] sm:text-4xl"
              >
                I have already built what you are trying to build. Now
                let&apos;s build yours.
              </h2>
              <p className="mt-4 max-w-2xl leading-relaxed text-[#625f6d]">
                Companies, offers, audiences, ecommerce operations, fulfillment,
                sales processes, websites, and software built under real
                pressure, with real money on the line. This dashboard is not a
                demo somebody designed for a portfolio. It is the reporting
                layer of a working business, and the same machine gets installed
                for clients.
              </p>
              {proof.length > 0 && (
                <dl className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
                  {proof.map((p) => (
                    ...
                    >
                      <dt className="order-2 mt-1 text-[12px] leading-snug text-[#625f6d]">
                        {p.label}
                      </dt>
                      <dd className="order-1 text-2xl font-black text-[#20212b]">
                        {p.value}
                      </dd>
                    </div>
                  ))}
              ...
              <div className="mt-8">
                <Link
                  href="/about"
                  className="inline-flex items-center gap-2 text-sm font-bold text-[#5135e5] hover:text-[#3c25b6]"
                >
      ...
      {/* ---- closing CTA ---- */}
      <section
        className={`cb-band ${styles.closingSection}`}
      ...
      >
        <div className="cb-shell">
          <div className={styles.closingPanel}>
            <h2
              id="closing-heading"
              className="font-display text-3xl font-black tracking-tight text-[var(--heading)] sm:text-4xl"
            >
              This Is What Your Business Could See.
            </h2>
            <p className="mx-auto mt-4 max-w-2xl leading-relaxed text-[var(--text)]">
              Your website should not leave you guessing. You should know where
              people came from, what they clicked, where they left, which pages
              created leads, and what needs to be fixed next. Turn attention
              into conversations. Turn conversations into sales.
            </p>
            ...
            <div className="mt-7 flex flex-wrap justify-center gap-3">
              <CtaLink
                href="/start"
                event="build_my_system"
                placement="live_closing"
