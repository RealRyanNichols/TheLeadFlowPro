...
export default async function OutreachActionCenter() {
  ...
  const [prospectResult, actionResult] = await Promise.all([
    supabase
      ...
      .select("id,business_name,industry,priority,status,owner_name,contact_name,contact_email,contact_phone,contact_verified_at,compliance_review_required,next_action_at")
  ...
  if (prospectResult.error || actionResult.error) throw new Error("Outreach Action Center is temporarily unavailable.");
    ...
    <div className="space-y-7">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          ["Open prospects", prospects.length, Target, "won/lost/do-not-contact excluded"],
