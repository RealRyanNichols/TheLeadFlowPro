...
export default async function ChatGPTCourseWelcomePage({
  searchParams,
}: {
      ...
      <section className="cb-band">
        <div className="cb-shell" style={{ maxWidth: 760, paddingTop: 96, paddingBottom: 96, textAlign: "center" }}>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", marginTop: 28 }}>
            <Link className="cb-btn cb-btn--primary" href="/login?mode=signup&next=/training/chatgpt-operator">Create or open your login</Link>
