...
import { ArrowRight, KeyRound, Mail, PenLine } from "lucide-react";
  ...
  return (
    <main className="cb-page pb-16">
      <div className="mx-auto w-full max-w-2xl px-4 pt-6 sm:pt-10">
        ...
        {reasonNote ? (
          <div className="mt-4 space-y-3 rounded-xl border border-[var(--line-strong)] bg-[var(--panel)] px-4 py-3">
            ...
            {reason === "canceled" ? <BuyButtons salesOpen={salesOpen} closedMessage={closedMessage(aiOn)} /> : null}
          </div>
        ) : null}
