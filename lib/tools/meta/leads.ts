...
export const LEAD_META: Record<string, ToolMeta> = {
  "missed-call-calculator": {
    ...
    presets: [
      { id: "law", label: "Law firm", industry: "legal", blurb: "Example starting point: six missed intake calls a week, a 3,500 dollar average matter, and no repeat purchases. Swap in your own numbers.", values: { missed: 6, closeRate: 25, ticket: 3500, repeats: 0 }, example: "Six missed intake calls a week at a 3,500 dollar average matter." },
      { id: "dental", label: "Dental office", industry: "dental-practice", blurb: "Example starting point: eight missed calls a week, a 450 dollar average visit, and five repeat visits after the first. Adjust to your own schedule.", values: { missed: 8, closeRate: 40, ticket: 450, repeats: 5 }, example: "Eight missed calls a week, 450 dollar average visit, six visits over the relationship." },
      { id: "medical", label: "Medical practice", industry: "medical-practice", blurb: "Example starting point: ten missed calls a week, a 250 dollar average visit, and seven repeat visits. Change any of it to match your practice.", values: { missed: 10, closeRate: 45, ticket: 250, repeats: 7 }, example: "Ten missed calls a week at a 250 dollar average visit." },
      { id: "realtor", label: "Realtor", industry: "real-estate", blurb: "Example starting point: five missed calls a week, a 7,500 dollar average commission, and no repeat purchases. Put in your own numbers.", values: { missed: 5, closeRate: 15, ticket: 7500, repeats: 0 }, example: "Five missed calls a week at a 7,500 dollar average commission." },
      { id: "mortgage", label: "Mortgage lender", industry: "mortgage-lending", blurb: "Example starting point: six missed application calls a week and a 4,200 dollar commission per funded loan. Swap in your own numbers.", values: { missed: 6, closeRate: 20, ticket: 4200, repeats: 0 }, example: "Six missed application calls a week at 4,200 dollars of commission per funded loan." },
      { id: "hvac", label: "HVAC company", industry: "hvac", blurb: "Example starting point: nine missed calls a week, a 450 dollar average ticket, and three repeat jobs after the first. Adjust for your season.", values: { missed: 9, closeRate: 35, ticket: 450, repeats: 3 }, example: "Nine missed calls a week in season at a 450 dollar average ticket." },
      { id: "plumbing", label: "Plumber", industry: "plumbing", blurb: "Example starting point: ten missed calls a week, a 350 dollar average call, and two repeat jobs. Make it match your call log.", values: { missed: 10, closeRate: 40, ticket: 350, repeats: 2 }, example: "Ten missed calls a week at a 350 dollar average call." },
      { id: "electrical", label: "Electrician", industry: "electrical", blurb: "Example starting point: seven missed calls a week, a 400 dollar average job, and two repeat jobs. Swap in your own numbers.", values: { missed: 7, closeRate: 35, ticket: 400, repeats: 2 } },
      { id: "roofing", label: "Roofer", industry: "roofing", blurb: "Example starting point: six missed calls a week, a 9,500 dollar average roof, and no repeat purchases. Put in your real ticket.", values: { missed: 6, closeRate: 20, ticket: 9500, repeats: 0 }, example: "Six missed calls a week at a 9,500 dollar average roof." },
      { id: "restaurant", label: "Restaurant", industry: "restaurant", blurb: "Example starting point: fifteen missed calls a week, a 60 dollar average order, and eleven repeat visits. Adjust to your own counts.", values: { missed: 15, closeRate: 55, ticket: 60, repeats: 11 } },
      { id: "salon", label: "Salon", industry: "hair-salon", blurb: "Example starting point: twelve missed booking calls a week, an 85 dollar average visit, and seven repeat visits. Make it yours.", values: { missed: 12, closeRate: 50, ticket: 85, repeats: 7 } },
      { id: "barber", label: "Barbershop", industry: "barbershop", blurb: "Example starting point: ten missed calls a week, a 35 dollar average cut, and thirteen repeat visits. Swap in your own numbers.", values: { missed: 10, closeRate: 55, ticket: 35, repeats: 13 } },
      { id: "security", label: "Security company", industry: "private-security", blurb: "Example starting point: four missed enquiries a week, an 1,800 dollar first contract, and one repeat purchase. Adjust to your pipeline.", values: { missed: 4, closeRate: 25, ticket: 1800, repeats: 1 } },
      { id: "dealership", label: "Auto dealership", industry: "auto-dealership", blurb: "Example starting point: twelve missed calls a week, 2,200 dollars of gross per sale, and one repeat purchase. Put in your own numbers.", values: { missed: 12, closeRate: 20, ticket: 2200, repeats: 1 }, example: "Twelve missed calls a week at 2,200 dollars of front and back gross." },
      { id: "tourism", label: "Tour or attraction", industry: "tourism", blurb: "Example starting point: ten missed booking calls a week, a 180 dollar average party, and one repeat visit. Adjust for your season.", values: { missed: 10, closeRate: 45, ticket: 180, repeats: 1 } },
    ],
  },
