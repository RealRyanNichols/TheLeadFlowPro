...
export const LADDER = [
  {
    kind: "Five-page foundation",
    name: "Website Launch",
    price: usd(PRICES.websiteLaunchTotal),
    lead: true,
    body: `An owned, mobile-first five-page website with lead capture behind it. ${usd(PRICES.websiteLaunchDeposit)} to start, the rest after you approve it, before launch.`,
    items: [
