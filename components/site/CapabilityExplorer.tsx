...
import CapabilityWorkflow from "./CapabilityWorkflow";
import workflowStyles from "./CapabilityWorkflow.module.css";
...
const CAPABILITY_VISUALS: Record<string, Partial<CapabilityVisual>> = {
  ...
  pipeline: {
    ...
    body: "A pipeline makes each opportunity, owner and next action visible. Move a record when real work happens, then keep the result with its history.",
  ...
  calls: {
    ...
    body: "Calls can be connected to the same source, customer record, owner, and follow-up queue as forms and texts. A missed call needs an assigned response, not another forgotten notification.",
    proofHref: "/premier-system",
  ...
  texts: {
    ...
    body: "Permission-based texting belongs beside the call history and the next task. Keep replies, opt-outs and responsibility visible to the person working the customer relationship.",
    proofHref: "/premier-system",
    proofLabel: "See the connected-system proof",
  ...
  email: {
    ...
    body: "Keep requested delivery, marketing permission, reply handling and delivery failures distinct. The customer record shows what was sent and what needs a human response.",
    guideHref: "/system/follow-up",
  },
  payments: {
  ...
  "admin-dashboards": {
    ...
    body: "Build the daily view around questions an owner can act on. The optional dated Academy snapshot shows aggregate dashboard information without private student records or admin controls.",
    proofHref: "/proof-floor",
    proofLabel: "Open the public proof floor",
    guideHref: "/system/reporting",
  },
  ...
  "your-analytics": {
    ...
    body: "Connect the source to the customer action and the verified result. Keep the reporting in a business-controlled account, with clear definitions and private information excluded.",
    proofHref: "/live",
...
function getCapabilityVisual(stage: Stage, capability: Capability): CapabilityVisual {
  ...
  return {
    ...base,
    ...override,
    title: override.title ?? `${capability.name} with a clear next move.`,
    body:
      override.body ??
      capability.build,
  };
  ...
  return (
    <div className="lfp-capability-explorer">
      <div className="lfp-capability-instruction" aria-hidden="true">
        ...
        Choose an area, then see how each capability works.
      </div>
      ...
      <div className="lfp-capability-workbench">
        <div className="lfp-capability-menu">
          ...
          <p className="lfp-capability-module-prompt">
            ...
            Choose a capability to see an example, what it does, and your next step.
          </p>
        ...
        >
          ...
          <figure className="lfp-capability-visual">
            <CapabilityWorkflow id={capability.id} />
            {capability.id === "lead-capture" || capability.id === "admin-dashboards" ? (
              <details className={workflowStyles.proof}>
                <summary>See a real operating snapshot · September 1, 2026</summary>
                <Image
                  src={capability.id === "lead-capture"
                    ? "/images/proof/pda-lead-source-proof-2026-09-01.png"
                    : "/images/proof/pda-kpi-proof-2026-09-01.png"}
                  alt={capability.id === "lead-capture"
                    ? "Premier Dental Academy aggregate lead sources and daily lead counts, September 1, 2026"
                    : "Premier Dental Academy aggregate owner-dashboard cards, September 1, 2026"}
                  width={capability.id === "lead-capture" ? 1232 : 1240}
                  height={capability.id === "lead-capture" ? 326 : 121}
                  sizes="(max-width: 980px) 100vw, 52vw"
                />
                <p>Source: Premier Dental Academy operating dashboard, captured September 1, 2026.
                  Aggregate information only; no private customer records. Historical snapshot, not a current total or a promise of results.
                  {capability.id === "admin-dashboards" ? " Revenue logged is the Supabase subtotal; Square is the payment source of truth." : ""}
                </p>
              </details>
            ) : null}
            <figcaption>
              ...
              <div className="lfp-capability-visual-actions">
                ...
                <Link href={visual.guideHref}>Read the practical guide</Link>
              </div>
            </figcaption>
          </figure>
