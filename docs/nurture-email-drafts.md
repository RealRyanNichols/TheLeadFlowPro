# 30-Day Meta Lead Nurture — Email Drafts for Ryan's Approval

Rendered from `lib/nurture/emails.ts` (the source of truth: edit copy there,
then re-run the render command in that file's header comment).
Sample lead: first name Fiona, form answer mentioning missed calls.
Every send appends the signature block and a signed one-click unsubscribe link.
Nothing sends until `NURTURE_SEQUENCE_ENABLED=true` and `NURTURE_LINK_SECRET`
are both set in Vercel.

---

## Day 1 (step 101) — Subject: Why I send one short email a day
...
## Day 2 (step 102) — Subject: The lead you already paid for
...
https://www.theleadflowpro.com/packages
```

---

## Day 3 (step 103) — Subject: Your website has one job
...
https://www.theleadflowpro.com/live
```

---

## Day 4 (step 104) — Subject: Speed is the feature nobody advertises
...
https://www.theleadflowpro.com/articles
```

---

## Day 5 (step 105) — Subject: What to text back when you miss a call
...
https://www.theleadflowpro.com/tools/missed-call-calculator
```

---

## Day 6 (step 106) — Subject: Your form is asking too much
...
https://www.theleadflowpro.com/contact
```

---

## Day 7 (step 107) — Subject: Week one, one move
...
## Day 8 (step 108) — Subject: Reviews are a salesman who works free
...
https://www.theleadflowpro.com/tools/google-review-link
```

---

## Day 9 (step 109) — Subject: Follow-up that does not feel like nagging
...
https://www.theleadflowpro.com/premier-system
```

---

## Day 10 (step 110) — Subject: One clear offer beats five vague ones
...
## Day 11 (step 111) — Subject: Your Google profile is a landing page
...
## Day 12 (step 112) — Subject: Automate the boring, keep the human
...
https://www.theleadflowpro.com/tools/task-automation-savings
```

---

## Day 13 (step 113) — Subject: The owner's hour
...
## Day 14 (step 114) — Subject: Two weeks in: what to do with all this
...
https://www.theleadflowpro.com/book
```

---

## Day 15 (step 115) — Subject: The five-minute rule
...
## Day 16 (step 116) — Subject: What is a lead actually worth to you?
...
https://www.theleadflowpro.com/tools/lead-value-calculator
```

---

## Day 17 (step 117) — Subject: A free tool picked for you

```text
Fiona,

When you filled out the form, you told me a little about what you are dealing with. Based on that, the free tool on my site I would hand you first is Missed Call Cost Calculator.
...
## Day 18 (step 118) — Subject: Why the posting always stops
...
https://www.theleadflowpro.com/go/time-back
```

---

## Day 19 (step 119) — Subject: One customer record beats five inboxes
...
## Day 20 (step 120) — Subject: The questions that pre-sell
...
## Day 21 (step 121) — Subject: Three weeks in. Pick your lane.
...
## Day 22 (step 122) — Subject: What a System Map finds
...
https://www.theleadflowpro.com/packages/system-map
```

---

## Day 23 (step 123) — Subject: The missed-call math
...
## Day 24 (step 124) — Subject: One more tool, on me

```text
Fiona,

Second tool pick, based on what you told me when you signed up: Task Automation Savings.
...
## Day 25 (step 125) — Subject: Ads buy attention. Systems keep it.
...
## Day 26 (step 126) — Subject: If they have to call to buy, some will not
...
## Day 27 (step 127) — Subject: What a real build looks like
...
## Day 28 (step 128) — Subject: The rent-versus-own ledger
...
## Day 29 (step 129) — Subject: What working with me actually looks like
...
## Day 30 (step 130) — Subject: Last one. Three doors.
...
2. Book a call and we will map your next move together: https://www.theleadflowpro.com/book
